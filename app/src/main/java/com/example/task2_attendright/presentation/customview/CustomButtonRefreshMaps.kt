...
class CustomButtonRefreshMaps @JvmOverloads constructor(context: Context, attr: AttributeSet? = null) : AppCompatButton(context,attr) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        text = context.getString(R.string.txt_refresh)
    }
}