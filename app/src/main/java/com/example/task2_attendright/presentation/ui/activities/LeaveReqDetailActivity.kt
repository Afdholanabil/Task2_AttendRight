...
import com.example.task2_attendright.databinding.ActivityLeaveReqDetailBinding
import com.example.task2_attendright.databinding.ImageDetailDialogBinding

class LeaveReqDetailActivity : AppCompatActivity() {
    private var _binding : ActivityLeaveReqDetailBinding? = null
    private val binding get() = _binding!!
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        _binding = ActivityLeaveReqDetailBinding.inflate(layoutInflater)
