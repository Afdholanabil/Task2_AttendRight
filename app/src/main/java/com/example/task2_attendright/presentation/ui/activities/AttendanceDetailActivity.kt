...
import com.example.task2_attendright.databinding.ActivityAttendanceDetailBinding
...
class AttendanceDetailActivity : AppCompatActivity() {
    private var _binding : ActivityAttendanceDetailBinding? = null
    private val binding get() = _binding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        _binding = ActivityAttendanceDetailBinding.inflate(layoutInflater)
